...
public class MultiListActivity2 {

	private static final String TAG = "MultiListActivity2";
	...
	public MultiListActivity2(Activity act, ViewGroup root) {
	...
	private void get_downloaded_apps() {
		...
		for(ApplicationInfo appInfo : all_apps) {
			if((appInfo.flags & ApplicationInfo.FLAG_SYSTEM) == 1&& 
			   (appInfo.flags & FLAG_UPDATED_SYS_APP) == 1 && 
			   appInfo.flags != 0)
