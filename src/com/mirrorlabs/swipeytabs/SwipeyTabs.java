...
import com.mirrorlabs.swipey.R;
...
public class SwipeyTabs extends ViewGroup implements OnPageChangeListener {
	...
	public static final int MSG_PAGE_CHANGED = 0x999;
	...
	/**
	 * Sends an empty message to the handler when onPageSelected() is called
	 * 
	 * The handler must be set after setAdapter() or it will be null
	 * 
	 * @param handler
	 */
	...
	public void onPageSelected(int position) {
		if (mHandler != null) {
			mHandler.sendEmptyMessage(MSG_PAGE_CHANGED);
		}
